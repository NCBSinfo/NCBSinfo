...
public enum CurrentActivity {
    ...
    HOME(Home.class, R.layout.home_base_layout, R.string.home, R.id.nav_home, false),
    TRANSPORT(Transport.class, R.layout.transport_base_layout, R.string.transport, R.id.nav_transport, false),;
