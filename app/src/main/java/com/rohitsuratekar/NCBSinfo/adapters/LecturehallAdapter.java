...
public class LecturehallAdapter extends BaseExpandableListAdapter implements Filterable {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            convertView = minflater.inflate(R.layout.lecture_halls_parentlist, parent,false);
        }
