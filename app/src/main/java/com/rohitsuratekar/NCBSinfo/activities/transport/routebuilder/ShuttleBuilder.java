 ...
 */
public class ShuttleBuilder extends TransportRoute {
    ...
    public ShuttleBuilder(RouteModel model, Context context) {
    ...
    public String getType() {
        return context.getResources().getString(R.string.shuttle);
    }
    ...
    public String getWeekTitle() {
        return context.getResources().getString(R.string.transport_list_week_title);
    }

    @Override
    public String getSundayTitle() {
        return context.getResources().getString(R.string.transport_list_sunday_title);
    }

    @Override
    public String getFooter1() {
        return context.getResources().getString(R.string.transport_footer1);
    }

    @Override
    public String getFooter2() {
        return context.getResources().getString(R.string.transport_footer2,
