            ...
            public void onChanged(@Nullable Boolean etDataHolder) {
                if (etDataHolder != null) {
                    if (etDataHolder) {
                        ...
                        Intent intent = new Intent(EditTransport.this, BaseActivity.class);
            ...
            if (data.getTripData().size() > 1) {
                ...
                for (TripData t : data.getTripData()) {
                    ...
                    if (data.isRegular() && t.getDay() != Calendar.SUNDAY) {
                        ...
                        button.setText(Helper.convertToString(calendar, "EEEE"));
                    }
                ...
                alertDialog.setPositiveButton("ok", new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Toast.makeText(getApplicationContext(), getString(R.string.mt_select_snackbar, String.valueOf(selectedIndex[0] + 1)), Toast.LENGTH_SHORT).show();
