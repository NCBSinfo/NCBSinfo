...
class TransportModel {
    ...
    TransportModel(Context context, Calendar calendar, RouteData routeData, List<TripData> tripData) {
        ...
        footnote = context.getString(R.string.transport_footnote, "21 Jun 2017", "NCBSinfo");
        if (isRegular) {
            leftTitle = context.getString(R.string.transport_weekday);
            rightTitle = context.getString(R.string.transport_sunday);
