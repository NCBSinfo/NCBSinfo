...
class LocationList {
    ...
    private ArrayList<String[]> listHalls() {
        ...
        LectureList.add(new String[]{"Centriole ", "CCAMP Meeting Room", "CCAMP Building", "First Floor", "CCAMP Building", "Meeting Room"});
        LectureList.add(new String[]{"Chausa", "CCAMP Seminar Hall", "CCAMP Building", "Ground Floor", "CCAMP Building", "Seminar Hall"});
        ...
        LectureList.add(new String[]{"Haapus ", "LH-1", "Eastern Labs", "Ground Floor", "In front of reception", "Lecture Hall"});
        LectureList.add(new String[]{"Himsagar", "LH-3", "Eastern Labs", "Second Floor", "In front of Wildlife office", "Lecture Hall"});
        LectureList.add(new String[]{"Langra", "LH-2", "Eastern Labs", "First Floor", "Above reception", "Lecture Hall"});
        LectureList.add(new String[]{"Malgova", "70 Seater", "Southern Labs", "Second Floor", "Next to Library", "Auditorium"});
        ...
        LectureList.add(new String[]{"Vesicle", "Oases", "Eastern Labs", "First Floor", "In front of CBI counter", "Open Air Meeting Space"});
        return LectureList;
    }
    ...
    public List<LocationModel> getLocations() {
        ...
        for (String[] s : listHalls()) {
            LocationModel model = new LocationModel();
            model.setName(s[0]);
            model.setOldName(s[1]);
            model.setDetails(s[4]);
            model.setBuilding(s[2]);
            model.setFloor(getFloor(s[3]));
            model.setType(s[5]);
            list.add(model);
        }
        return list;
