...
public class ContactList {
    ...
    public List<ContactModel> getAll() {
        ...
        for (Object o : all_list) {
            ...
            other.addAll(Arrays.asList((String[]) item[4]));
    ...
    private Object[][] all_list = {
            ...
            {"Office", "RDO", "ELC TF", "6224", new String[]{}, "NCBS", "Savita Ayyar "},
            ...
            {"Service ", "Meetings Office", "ELC FF", "6337", new String[]{"6337"}, "NCBS", "Bhavya S , Sharath M R "},
