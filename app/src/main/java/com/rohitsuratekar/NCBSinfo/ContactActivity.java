...
public class ContactActivity extends AppCompatActivity
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ContactTab1(), getString(R.string.contact_activity_tab1));
        adapter.addFragment(new ContactTab2(), getString(R.string.contact_activity_tab2));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
         ...
         startActivity(intent);
            ...
            Intent intent = new Intent(ContactActivity.this, NCBStoMandara.class);
            intent.putExtra("switch", String.valueOf(4));
            startActivity(intent);

        } else if (id == R.id.nav_other) {
            Intent intent = new Intent(ContactActivity.this, NCBStoOther.class);
