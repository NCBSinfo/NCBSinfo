...
public class Activity_AddContact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (forEdit == 1){
            ...
            inputName.setText(db.getContact(feldID).getContact_name());
            inputNumber.setText(db.getContact(feldID).getContact_extension());
            inputDepartment.setText(db.getContact(feldID).getContact_department());
            inputPosition.setText(db.getContact(feldID).getContact_position());
    ...
    private void submitForm() {
        ...
        DatabaseHelper db = new DatabaseHelper(this);
        if (forEdit==0){ db.addContact(new models_contacts_database(pseudoIncrement,contactName, contactDepartment, contactPosition,contactNumber,"0"));
        ...
        else{db.updateContact(new models_contacts_database(feldID, contactName, contactDepartment, contactPosition, contactNumber, "0"));
