package com.rohitsuratekar.NCBSinfo.online.maps;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        if (currentRoute == TransportConstants.ROUTE_NCBS_CBL) {
    ...
    private void putStops(int route) {
        ...
        if (route == TransportConstants.ROUTE_NCBS_IISC) { //NCBS-IISc
        ...
        } else if (route == TransportConstants.ROUTE_IISC_NCBS) { //IISc-NCBS
        ...
        } else if (route == TransportConstants.ROUTE_NCBS_MANDARA) { //NCBS-Mandara
        ...
        } else if (route == TransportConstants.ROUTE_MANDARA_NCBS) { //Mandara-NCBS
        ...
        } else if (route == TransportConstants.ROUTE_BUGGY_NCBS) { //Buggy from NCBS
            //Nothing is here
        } else if (route == TransportConstants.ROUTE_BUGGY_MANDARA) { //Buggy from Mandara
            //Nothing is here
        } else if (route == TransportConstants.ROUTE_NCBS_CBL) { //CBL
            final AlertDialog alertDialog = new AlertDialog.Builder(MapActivity.this).create();
