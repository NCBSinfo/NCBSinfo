...
public class CAMPadapter extends RecyclerView.Adapter<CAMPadapter.MyViewHolder> implements UserInformation {
    ...
    public CAMPadapter(List<ConferenceModel> entryList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.camp_event_item, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (entry.getEventCode() != null) {
            if (entry.getEventCode().toUpperCase().equals(registration.camp16.events.CAMP2016_ACTIVITY)) {
                holder.speaker.setVisibility(View.GONE);
            }
            if (entry.getEventCode().toUpperCase().equals(registration.camp16.events.CAMP2016_TUTORIAL)) {
    ...
    private String convertDate(String oldFormat) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.i(TAG, "Failed Parsing date : " + oldFormat);
            returnString = "N/A";
        }
    ...
    private String convertTime(String start, String end) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.i(TAG, "Failed Parsing date : " + start + " " + end);
            returnStart = "N/A";
        }
