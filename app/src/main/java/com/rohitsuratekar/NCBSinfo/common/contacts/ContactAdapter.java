...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.DataObjectHolder> implements Filterable {
    ...
    public class DataObjectHolder extends RecyclerView.ViewHolder
        ...
        TextView ContactName, ContactNumber, ContactDepartment, FirstLetter;

        ImageButton favButton;
        LinearLayout thumbnil;

        public DataObjectHolder(View itemView) {
            super(itemView);
            ContactName = (TextView) itemView.findViewById(R.id.contact_item_title);
            ContactNumber = (TextView) itemView.findViewById(R.id.contact_item_number);
            ContactDepartment = (TextView) itemView.findViewById(R.id.contact_item_department);
            favButton = (ImageButton) itemView.findViewById(R.id.contact_fav_button);
            thumbnil = (LinearLayout) itemView.findViewById(R.id.contact_thumbnail);
            FirstLetter = (TextView) itemView.findViewById(R.id.contact_letter);
    ...
    public void onBindViewHolder(final DataObjectHolder holder, final int position) {
        ...
        holder.thumbnil.setBackgroundColor(new ContactColors(context, firstLetter.toLowerCase()).colorID);
        holder.FirstLetter.setText(firstLetter.toUpperCase());
        final int k = mDataset.get(position).getId();
        ImageButton img = (ImageButton) holder.itemView.findViewById(R.id.contact_fav_button);
        img.setColorFilter(null);
        if (new ContactsData(context).get(k).getFavorite().equals("1")) {
