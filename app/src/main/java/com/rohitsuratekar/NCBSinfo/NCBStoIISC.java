...
public class NCBStoIISC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.title_activity_ncbsto_iisc));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent;
            intent = new Intent( NCBStoIISC.this, SettingsActivity.class );
            ...
            Intent intent = new Intent(NCBStoIISC.this, NCBStoMandara.class);
